			...
			<BiographyArea>
				<section id="biography">
					<ProfileContent>
						<h2>
							Nome:{" "}
							{this.props.fullname ? this.props.fullname : "Não revelado."}
						</h2>
						<ul>
							<li>
								Gênero:
								<span>
									{this.props.gender ? this.props.gender : "Não possui."}
								</span>
							</li>
							<li>
								Raça:
								<span>
									{this.props.race ? this.props.gender : "Desconhecida."}
								</span>
							</li>
							<li>
								Altura:
						...
						<label htmlFor="publisher">
							Publicado por:
							<span id="publisher">
								{this.props.publisher ? this.props.publisher : "Desconhecido."}
							</span>
						</label>
						...
						<label htmlFor="alignment">
							Seguimento:
							<span id="alignment">
								{this.props.alignment ? this.props.alignment : "não possui."}
							</span>
						</label>
					</ProfileContent>
				</section>
				...
				<section id="work">
					<ProfileContent>
						<label htmlFor="occupation">
							Ocupação:
							<span id="occupation">
								{this.props.occupation ? this.props.occupation : "Nenhuma"}
							</span>
						</label>
						<label htmlFor="base">
							Base:
							<span id="base">
								{this.props.base ? this.props.base : "Não possui base."}
							</span>
						</label>
					</ProfileContent>
				</section>
				...
				<section id="connections">
					<ProfileContent>
						<label htmlFor="group-affiliation">
							Grupo(s) afiliado:
							<span id="group-affiliation">
								{this.props.group ? this.props.group : "Nenhuma afiliação."}
							</span>
						</label>
